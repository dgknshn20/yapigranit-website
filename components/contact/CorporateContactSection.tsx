...
export default function CorporateContactSection({
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const details = [
      `Proje Türü: ${projectType === "home" ? "Ev Projesi" : "Kurumsal"}`,
      area ? `Alan: ${area}` : null,
      size ? `Tahmini Ölçü: ${size}` : null,
      color ? `Taş Rengi / Doku: ${color}` : null,
              ...
              <div className="relative z-10 space-y-8">
                <div>
                  ...
                  <p className="text-gray-400 leading-relaxed text-sm lg:text-base">
                    Mermer ve doğal taş projeleriniz için mimari ekibimizden
                    hızlı teklif alın. Detayları paylaşın, 24 saat içinde dönüş
                    yapalım.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 text-sm">
                    <div className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gold">
                      ...
                      >
                        <path
                          d="M22 16.9v2a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3.1-8.6A2 2 0 0 1 4.1 2h2a2 2 0 0 1 2 1.7c.1.9.3 1.8.6 2.7a2 2 0 0 1-.5 2L7 9a16 16 0 0 0 6 6l.6-.2a2 2 0 0 1 2 .5 12.5 12.5 0 0 0 2.7.6 2 2 0 0 1 1.7 2z"
                          strokeWidth="1.5"
                        />
                      </svg>
                    </div>
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <div className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gold">
                      ...
                      >
                        <path
                          d="M12 22s7-4.4 7-10a7 7 0 0 0-14 0c0 5.6 7 10 7 10z"
                          strokeWidth="1.5"
                        />
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="flex p-1 bg-white/5 rounded-lg border border-white/10">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M3 11l9-7 9 7v9a2 2 0 0 1-2 2h-5v-7H10v7H5a2 2 0 0 1-2-2z"
                          strokeWidth="1.5"
                        />
                      </svg>
                      Ev Projesi
                    ...
                    >
                      ...
                      >
                        <path
                          d="M3 21h18M6 21V7a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v14M9 21V9h6v12"
                          strokeWidth="1.5"
                        />
                      </svg>
                      Kurumsal
